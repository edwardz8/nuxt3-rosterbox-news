    ...
    <div class="container mx-auto py-20 px-4 flex flex-wrap">
      <div class="left 2xl:w-1/3 xl:w-1/3 lg:w-1/3 md:w-1/2 lg:pr-0 pr-2 mt-4">
        <h1 class="title-font font-medium text-3xl text-gray-900">
          Subscribe to the rosterbox football newsletter 🏈
        </h1>
        <p class="leading-relaxed mt-4 mb-4">
          Sign up to receive the rosterbox newsletter -- an educational, entertaining & statistically informed approach to dynasty, seasonal and daily fantasy football -- straight to your inbox!
        </p>
       <img :src="'/images/pat-football.png'" class="mb-2" />
      </div>
      <div
